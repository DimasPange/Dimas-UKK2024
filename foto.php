...
<body>
    <nav class="navbar navbar-expand-lg bg-body">
        <div class="container">
            <a class="navbar-brand" href="index.php">Galleri</a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hapus_foto.php?fotoid=<?= $data['fotoid'] ?>" onclick=" return confirm('Yakin ingin hapus')"  class="btn btn-danger">Hapus</a>
